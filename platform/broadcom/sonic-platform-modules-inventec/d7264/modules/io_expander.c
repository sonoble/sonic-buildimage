...
struct ioexp_map_s ioexp_map_sequoia_p56p63 = {
    ...
    .map_lpmod      = { {1, 0, 3}, /* map_lpmod[0] = LPMODE_QSFP28_P(X)   */
                        {1, 0, 2}, /* map_lpmod[1] = LPMODE_QSFP28_P(X+1) */
                        {1, 0, 1}, /* map_lpmod[2] = LPMODE_QSFP28_P(X+2) */
                        {1, 0, 0}, /* map_lpmod[3] = LPMODE_QSFP28_P(X+3) */
                        {1, 0, 7}, /* map_lpmod[4] = LPMODE_QSFP28_P(X+4) */
                        {1, 0, 6}, /* map_lpmod[5] = LPMODE_QSFP28_P(X+5) */
                        {1, 0, 5}, /* map_lpmod[6] = LPMODE_QSFP28_P(X+6) */
                        {1, 0, 4}, /* map_lpmod[7] = LPMODE_QSFP28_P(X+7) */
    },
    .map_modsel     = { {0, 0, 0}, /* map_modsel[0] = MODSEL_QSFP28_N_P(X)   */
                        {0, 0, 1}, /* map_modsel[1] = MODSEL_QSFP28_N_P(X+1) */
                        {0, 0, 2}, /* map_modsel[2] = MODSEL_QSFP28_N_P(X+2) */
...
get_ioexp_map(int ioexp_type){
    switch (ioexp_type){
        ...
        case IOEXP_TYPE_SEQUOIA_P56P63:
            return &ioexp_map_sequoia_p56p63;
